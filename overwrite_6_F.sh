...
./db_bench_6 --benchmarks="overwrite,stats,levelstats" \
--use_existing_db=1 \
--sync=0 \
...
--merge_operator="put" \
--seed=1642907605 \
--report_file=${4}/6write_Dataset_${2}G_Value_${3}_DisWal_${5}_F.csv \
| tee ${4}/6write_Dataset_${2}G_Value_${3}_DisWal_${5}_F.txt \
